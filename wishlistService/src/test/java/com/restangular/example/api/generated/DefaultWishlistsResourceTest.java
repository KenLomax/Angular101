...
public final class DefaultWishlistsResourceTest extends com.restangular.example.api.generated.AbstractResourceTest
{
	/**
...
{
    final WebTarget target = getRootTarget(ROOT_RESOURCE_PATH).path("/wishlistId/wishlistItems");
    final com.restangular.example.api.generated.WishlistItem entityBody =
    new com.restangular.example.api.generated.WishlistItem();
    final javax.ws.rs.client.Entity<com.restangular.example.api.generated.WishlistItem> entity =
    javax.ws.rs.client.Entity.entity(entityBody,"application/json");
    final Response response = target.request().post(entity);
    Assert.assertNotNull("Response must not be null", response);
    Assert.assertEquals("Response does not have expected response code", Status.CREATED.getStatusCode(), response.getStatus());
